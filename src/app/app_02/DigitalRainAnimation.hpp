...
public:
  ...
  void setBigText(bool on) {
    fontSize = on ? DEFAULT_FONT_SIZE * 1 : DEFAULT_FONT_SIZE;
    lineWidth = on ? DEFAULT_LINE_WIDTH * 1 : DEFAULT_LINE_WIDTH;
    letterHeight = on ? DEFAULT_LETTER_HEIGHT * 1 : DEFAULT_LETTER_HEIGHT;
  }
